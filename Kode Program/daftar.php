...
if (mysqli_num_rows($query) > 0) {
    ...
    $mail->Subject = 'Verifikasi Akun - To-Do List';

    //Read an HTML message body from an external file, convert referenced images to embedded,
    //convert HTML into a basic plain-text alternative body
    $body = "Hi, " . $username . "<br>Please verification your email before access our website : <br> http://localhost:8080/To-Do-List/confirmEmail.php?code=" . $code;
    $mail->Body = $body;
    //Replace the plain text body with one created manually
    $mail->AltBody = 'Verifikasi Akun';
